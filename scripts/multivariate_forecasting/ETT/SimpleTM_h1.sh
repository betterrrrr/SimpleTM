...
run_log_file="$project_root/result_h1.log"
{
  echo ""
  echo "===== $(date '+%F %T') Start scripts/multivariate_forecasting/ETT/SimpleTM_h1.sh ====="
} >> "$run_log_file"
...
result_file = project_root / 'result_ETTh1.txt'
...
print(f'[summary] wrote aggregated ETTh1 results to {result_file}')
PY
