...
run_log_file="$project_root/result_m1.log"
{
  echo ""
  echo "===== $(date '+%F %T') Start scripts/multivariate_forecasting/ETT/SimpleTM_m1.sh ====="
} >> "$run_log_file"
...
result_file = project_root / 'result_ETTm1.txt'
...
print(f'[summary] wrote aggregated ETTm1 results to {result_file}')
PY
